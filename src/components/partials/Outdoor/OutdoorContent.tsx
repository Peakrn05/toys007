...
const OUTDOOR_PRODUCTS = ALL_PRODUCTS.filter(
  (p) => p.category === "Outdoor" || p.category === "Remote Control"
);
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="page-banner-title">Outdoor Collection</h1>
              <p className="page-banner-subtitle">
                {OUTDOOR_PRODUCTS.length} products for outdoor adventures
              </p>
            </div>
          </div>
        </div>
